                                                                                            ...
                                                                                            <tr>
                                                                                                ...
                                                                                                <td align="left" class="Pad-L5">
                                                                                                    <actl:RequiredFieldValidator ID="reqValAdultPrice" ValidationGroup="RateSetup" ControlToValidate="txtAdultPrice"
                                                                                                        runat="server" ResourceName="reqValAdultPrice" Display="Dynamic" ErrorMessage="[Please enter Price for Adults.]">
                                                                                                    </actl:RequiredFieldValidator>
                                                                                                </td>
                                                                                                <%--<td align="left" class="Pad-L5">
                                                                                                    <actl:CompareValidator ID="compValAdultPrice" ValidationGroup="RateSetup" runat="server"
                                                                                                        ControlToValidate="txtAdultPrice" Display="Dynamic" ErrorMessage="[Price for Adults - Please enter numeric value.]"
                                                                                                        Operator="DataTypeCheck" ResourceName="regExpAdultPrice" Type="Currency">
                                                                                                    </actl:CompareValidator>
                                                                                                </td>--%>
                                                                                                <td class="Pad-L2">
                                                                                                    <actl:CustomValidator ID="custValCFRatesAdultPrice" ResourceName="regExpAdultPrice"
                                                                                                        ...
                                                                                                        ClientValidationFunction="custValRateTextBox" ErrorMessage="[Price for Adults - Please enter numeric value.]"
                                                                                    ...
                                                                                    <td class="Pad-L20 Pad-T10">
                                                                                        <table border="0" cellpadding="0" cellspacing="0">
                                                                                            <tr>
                                                                                                ...
                                                                                                <td align="left" class="Pad-L5">
                                                                                                    <actl:RequiredFieldValidator ID="reqValSingleAdult" ResourceName="reqValSingleAdult" ValidationGroup="RateSetup" Display="Dynamic" ErrorMessage="Please enter Single Adult Price."
